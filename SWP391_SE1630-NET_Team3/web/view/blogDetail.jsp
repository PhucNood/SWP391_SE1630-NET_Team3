					...
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="flex-w flex-t p-t-16">
							...
							<div class="flex-w size-217">
								<a href="${pageContext.request.contextPath}/view/#" class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5">
									Streetstyle
								</a>
				...
				<div class="col-md-4 col-lg-3 p-b-80">
					<div class="side-menu">
						...
						<div class="p-t-55">
							...
							<ul>
								<li class="bor18">
									<a href="${pageContext.request.contextPath}/view/#" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">
										Fashion
									</a>
								</li>
