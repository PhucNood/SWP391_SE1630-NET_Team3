            ...
            <div id="addEmployeeModal" class="">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="addProductImage?productID=${product.productID}" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                <a type="button" href="editProduct?productID=${product.productID}" class="btn btn-success" data-dismiss="modal" value="Cancel">Cancel</a>
