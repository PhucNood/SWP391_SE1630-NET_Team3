            ...
            <div class="table-wrapper">
                ...
                <div class="flex-w flex-sb-m p-b-52 " style="justify-content: end">
                    <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                        <a href="myOrder" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${(status == '') ? "how-active1" : ""}">
                            All Order
                        </a>
                        <a href="myOrder?status=Confirm" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${(status == 'Confirm') ? "how-active1" : ""}">
                            Confirm
                        </a>

                        <a href="myOrder?status=Delivering" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${(status == 'Delivering') ? "how-active1" : ""}"  >
                            Delivering
                        </a>

                        <a href="myOrder?status=Received" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${(status == 'Received') ? "how-active1" : ""}" >
                            Received
                        </a>
                        <a href="myOrder?status=Cancle" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${(status == 'Cancle') ? "how-active1" : ""}" >
                            Cancle
                        </a>    
                    ...
                    <div class="dis-none panel-search w-full p-t-10 p-b-15">
                        <form class="example" action="myOrder" method="get">
                                        ...
                                        <tr class="info">
                                            ...
                                            <td class ="cart_total" style="text-align: center; ">
                                                <button class="btn btn1">
                                                    <a href="orderDetailCustomer?id=${o.orderID}">Detail</a>
                                                </button>
                                            </td>
                                        </tr>
                                    </c:forEach>
