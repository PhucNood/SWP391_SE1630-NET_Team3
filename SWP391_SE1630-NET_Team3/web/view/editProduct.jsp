            ...
            <div id="addEmployeeModal" class="">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="saveEditProduct?productID=${product.productID}" method="post" >
                                ...
                                <div class="form-group" >
                                    ...
                                    <c:forEach var="j" items="${product.list}">
                                        <div class="col-sm-6 col-md-4 col-lg-3 ">
                                            ...
                                            <a href="deleteProductImage?productID=${product.productID}&img=${img}" onclick="alertUser(${product.productID},${img})" class="delete" data-toggle="modal">
