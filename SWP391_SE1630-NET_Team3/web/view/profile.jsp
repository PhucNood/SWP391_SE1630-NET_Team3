            ...
            <div class="box">
                ...
                <div class="inner-box">
                    ...
                    <form action="changeinfo" >
                        <h2>My Profile</h2>
                        Full Name<input type="text" name="fullname" placeholder="Your Full Name" value="${requestScope.fullname}" required/>
                        User Name<input type="text" name="username" placeholder="Username" required value="${requestScope.username}"/>
                        Phone<input type="text" name="phone" placeholder="Phone" value="${requestScope.phone}" required/>
                        Address<input type="text" name="address" placeholder="Address" required value=""/>
